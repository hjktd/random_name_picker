const name = ["刘宁","高致远","陈博文","陈家赫","赵雨洋","谢振轩","胡博文","崔柏文","邵允哲","刘思齐","纪文慧","刘冬宇","娄宇轩","冯子芮","于雅凡","蔡亚君","陈力","刘俊淇","刘明仁","王宇翔","徐崇轩","姚朴尘","周金阳","周墨","夏梓涵","许庄子","陈灿","宁浩辰","王希","宋奥棋","史文研","赵栗","张子茉","王秋越","王如意","甄畅畅","王熙","仝礼铭","周子谦","胥雨函","魏明昕","何珍玉","刘宇祺","赵宇顺","宋唱","陈苏皖","王子博","韦墨","鲁荣凯","鲍亦轩","沈涵","赵悦岳","王迎奥","卢子涵","程晓宁","王猛"];
const star = [3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3];
const version=2;
//配置文件编辑器：
